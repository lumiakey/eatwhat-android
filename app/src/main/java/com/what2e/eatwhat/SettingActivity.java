...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    EatWhatApplication application;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1://版本检查
                    Util.showToast(SettingActivity.this, "当前是最新版本了哟");
                    break;
                default:
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        application = (EatWhatApplication) getApplication();
        pg = new ProgressDialog(SettingActivity.this);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_exitLogin:
                ...
                if (statusCode == 200) {
                    new AlertDialog.Builder(SettingActivity.this).setTitle("退出")
                            .setMessage("确定要退出登录？")
                    ...
                    Toast.makeText(SettingActivity.this, "你还未登录，请先登录!", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
